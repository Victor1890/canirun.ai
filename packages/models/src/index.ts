...
const STATIC_MODELS: AIModel[] = [
  ...
  { id: "bonsai-27b", name: "Bonsai 27B", provider: "Prism ML", family: "Bonsai", params: "27B", paramsBillions: 27, architecture: "dense", releaseDate: "2026-07", contextLength: 262144, useCase: ["chat", "vision", "reasoning"], description: "Full 27B-class reasoning in binary transformer weights. Packaged with a Q8_0 vision projector.", url: "https://ollama.com/MichelRosselli/bonsai-27b", minRamGB: 4.4, recommendedRamGB: 8, quants: [{ name: "Q1_0", bits: 1, vramGB: 4.4, diskGB: 4.4, quality: "good" }], ollamaId: "MichelRosselli/bonsai-27b", lmStudioId: "prism-ml/bonsai-27b", tools: true, thinking: true, license: "Apache 2.0" },
];
